...
;   ya se han marcado todos los espejos o la celda ya esta marcada
  ...
  MarcarEspejo PROC
   ...
   BorrarMarcaEspejo:
    ...
    mov al,caractImprimirMatrizJuego[0]
    mov bl,0     
    call ImprimirCarColor 
    
    mov al,posMatrizJuego 
    call BorrarElementoVector 
...
;F: Borra un elemento de un vector
;E: AL numero a borrar
;   SI vector a modificar
;   CL numero de elementos del vector
  
  BorrarElementoVector PROC
   ...
   ActualizarVector:
    ...
    loop ActualizarVector 
    
    mov [si],-1
    
    dec numEspejosMarcados 
       
   FinalBorrarElementoVector:
