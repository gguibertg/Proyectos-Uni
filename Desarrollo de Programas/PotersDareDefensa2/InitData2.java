...
public class InitData2
{
    ...
    private void initData2()
    {
       ...
       Character silvanus = new DefensiveCharacter("Silvanus Kettleburn", new OffensiveHawthorn("SilvanusW"));
        ...
        draco = new PolyJuicePotioned(draco);
        
        Character dolores = new OffensiveCharacter("Dolores Umbridge", new OffensiveHawthorn("DoloresW"));
        dolores = new PolyJuicePotioned(dolores);
