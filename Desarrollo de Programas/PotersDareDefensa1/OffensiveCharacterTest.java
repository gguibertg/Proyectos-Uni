...
public class OffensiveCharacterTest
{
    ...
    private OffensiveCharacter enemy;
    ...
    public void setUp()
    {
        ...
        rafael = new OffensiveCharacter("Rafa", defensiveWand);
        enemy = new OffensiveCharacter("Antonio", offensiveWand);
    }
    ...
    {
        assertEquals(25, rafael.getOffensive(), 0.1);
    }
    ...
    {
        assertEquals(20.0, rafael.getDefensive(), 0.1);
    }
    ...
    {
        assertEquals(21.5, rafael.attack(), 0.1);
    }
    ...
    public void fightTest()
    {
        ...
        rafael.fight(enemy);
        assertEquals(15.5, enemy.getEnergy(), 0.1);
    }
