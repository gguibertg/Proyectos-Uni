...
public class House 
{
     ...
     *  
     */
    public House(String name, boolean reverse, Comparator<Character> order, boolean sort)
    {
    ...
    public void showCharacters(PrintWriter printW){
        if(sort == false){
            printW.println("The instances using this order behavior does not apply any order");
        }
